...
#' loadWeatherData(charlotteStations, startDate = "3/1/2015", endDate = "3/7/2015")
#' }
#'
#' There are 28 stations here which can be used to sample the shiny visualizations
#' and test some of the other methods.
#'
